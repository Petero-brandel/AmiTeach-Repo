...
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_parentId_Parent_id_fk" FOREIGN KEY ("parentId") REFERENCES "public"."Parent"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "Quiz" ADD CONSTRAINT "Quiz_teacherId_Teacher_id_fk" FOREIGN KEY ("teacherId") REFERENCES "public"."Teacher"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "QuizResult" ADD CONSTRAINT "QuizResult_quizId_Quiz_id_fk" FOREIGN KEY ("quizId") REFERENCES "public"."Quiz"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "QuizResult" ADD CONSTRAINT "QuizResult_studentId_Student_id_fk" FOREIGN KEY ("studentId") REFERENCES "public"."Student"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "StudyMaterial" ADD CONSTRAINT "StudyMaterial_teacherId_Teacher_id_fk" FOREIGN KEY ("teacherId") REFERENCES "public"."Teacher"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
